<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="SinaWB._Default" validateRequest="false" %>
...
<body>
    ...
    <asp:Button ID="sinaButton" runat="server" onclick="sinaButton_Click" 
        Text="连接sina" /><asp:Label ID="Label4" runat="server" Text="Methods:"></asp:Label>
    <br />
    <br />
...
&nbsp;
    <asp:DropDownList ID="DropDownList" runat="server" Height="20px" Width="142px">
        ...
        <asp:ListItem Value="7">Users/show</asp:ListItem>
    </asp:DropDownList>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
